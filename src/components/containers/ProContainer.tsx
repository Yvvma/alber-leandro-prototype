        ...
        <div className="bg-white">
          ...
          <div className="p-8 relative">
            ...
            <div id="skater" className="flex flex-col">
              <img src="/photos/alber-qix-03.webp" alt="alber-qix" width="400" height="400" loading="lazy" className="max-w-max" />
              <img src="/photos/alber-11.webp" alt="alber-stevie-williams" width="400" height="400" loading="lazy" className="max-w-max" />
            </div>
          ...
          <div id="entrepeneur" className="relative">
            <div className="flex flex-col z-[50] justify-end items-end bg-gradient-to-br from-black via-[#131313] to-[#141414]">
              ...
              <div className="p-4 flex flex-col gap-2 text-sm">
                <p className="font-helvetica font-[500] uppercase text-white tracking-tight">{t('entrepreneur.p1')}</p>
                <p className="font-helvetica font-[500] uppercase text-white tracking-tight">{t('entrepreneur.p2')}</p>
                <p className="font-helvetica font-[500] uppercase text-white tracking-tight">{t('entrepreneur.p3')}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <section className="max-w-7xl mx-auto px-8 py-16">
          ...
          <div className="grid grid-cols-3 gap-4 auto-rows-[180px]">
            <div className="col-span-2 row-span-2">
              <img src="/photos/alber-qix-03.webp" alt="alber-qix" width="800" height="360" loading="lazy" className="w-full h-full object-cover rounded-lg" />
            </div>
            <div className="row-span-2">
              <img src="/photos/alber-01.webp" alt="Alber" width="400" height="360" loading="lazy" className="w-full h-full object-cover rounded-lg object-[20%_40%]" />
            </div>
            <div>
              <img src="/photos/alber-11.webp" alt="alber-stevie-williams" width="400" height="180" loading="lazy" className="w-full h-full object-cover rounded-lg" />
            </div>
            <div>
              <img src="/photos/skater-alber.webp" alt="skater" width="400" height="180" loading="lazy" className="w-full h-full object-cover rounded-lg" />
            </div>
            <div>
              <img src="/photos/alber-usa-04.webp" alt="usa" width="400" height="180" loading="lazy" className="w-full h-full object-cover rounded-lg" />
            </div>
            <div>
              <img src="/photos/alber-usa-02.webp" alt="usa" width="400" height="180" loading="lazy" className="w-full h-full object-cover rounded-lg" />
            </div>
            <div>
              <img src="/photos/alber-usa-03.webp" alt="usa" width="400" height="180" loading="lazy" className="w-full h-full object-cover rounded-lg" />
            </div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto items-end justify-end py-16">
            ...
            <div className="grid grid-cols-2 gap-8 items-center">
              <div className="space-y-4">
                <img src="/photos/alber-03.webp" alt="Alber" width="600" height="400" loading="lazy" className="w-full h-[400px] object-cover rounded-lg object-[20%_40%]" />
                <img src="/photos/alber-02.webp" alt="Alber" width="600" height="300" loading="lazy" className="w-full h-[300px] object-cover rounded-lg object-[20%_40%]" />
              </div>
